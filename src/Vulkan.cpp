...
Vulkan::Vulkan(Window* pWindow):m_pWindow(pWindow)
{
    CreateInstance();
    SetupDebugMessenger();
    CreateSurface();
...
std::vector<const char*> Vulkan::GetRequireExtensions()
{
...
void Vulkan::SetupDebugMessenger()
{
    ...
    if (CreateDebugUtilsMessengerEXT(m_instance, &createInfo, nullptr, &m_debug) != VK_SUCCESS)
    {
        throw std::runtime_error("failed to set up debug messenger!");
    }
}

VkDebugUtilsMessengerCreateInfoEXT Vulkan::PopulateDebugMessengerCreateInfo()
{
...
{
    if (glfwCreateWindowSurface(m_instance, m_pWindow->m_pWindow, nullptr, &m_surface) != VK_SUCCESS) {
